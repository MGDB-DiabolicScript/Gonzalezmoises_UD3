...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=cataratas&box=-79.002984,43.190607,-79.224766,43.028911
...
-----------
  ...
  * cataratas Height Map (ASTER 30m).png
  ...
  * cataratas Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * cataratas Height Map (SRTM3 v4.1).png
  ...
  * cataratas Height Map (SRTM30 Plus).png
  ...
  * cataratas Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 40m (actual) is equal to 40m in
